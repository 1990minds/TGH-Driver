...
export const fetchAllbooking = (id) => async (dispatch) => {
  dispatch(getbooking());
  const key = "fetchAllbooking";
  try {
    const { data } = await axios.get(
        keyUri.BACKEND_URI + `/api/getbookings/${id}`,
      config
    );
...
export const createbooking = (values) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
        keyUri.BACKEND_URI + `/api/createbooking`,
      values,
      config
    );
...
export const fetchonebooking = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get(
        keyUri.BACKEND_URI + `/api/get-booking/${id}`,
      config
    );
...
export const updatebooking = (values, id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.put(
        keyUri.BACKEND_URI + `/api/update-booking/${id}`,
      values,
      config
    );
...
export const deletebooking = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.delete(
        keyUri.BACKEND_URI + `/api/delete-booking/${id} `,
      config
    );
    if (data && data.msg) {
